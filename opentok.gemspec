...
require File.expand_path('lib/opentok/version.rb', __dir__)
...
Gem::Specification.new do |spec|
  ...
  spec.summary     = 'Ruby gem for the OpenTok API'
  ...
  spec.add_dependency 'addressable', '> 2.3', '< 3.0' #  2.3.0 <= version < 3.0.0
  spec.add_dependency 'httparty', '>= 0.15.5', '< 0.18'
